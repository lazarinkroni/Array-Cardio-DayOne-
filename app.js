...
// Step one taking the inventor and loop over
// if the inventor is greater or equal 1500 and the inventor is less than 1600 return true
// we keep it
...
console.log("number of total years all togheter ", totalYears);

// 5. Sort the inventors by years lived
const oldest = inventors.sort(function (a, b) {
  const lastGuy = a.passed - a.year;
  const nextGuy = b.passed - b.year;
  // This is exacly as an if Statement
